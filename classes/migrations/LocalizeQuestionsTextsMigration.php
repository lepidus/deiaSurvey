...
class LocalizeQuestionsTextsMigration extends Migration
{
    ...
    {
        $allQuestions = DB::table('deia_questions')->get();
        ...
        foreach ($allQuestions as $question) {
            ...
            $responseOptions = DB::table('deia_response_options')
    ...
    {
        $settings = [];
        $settingRows = DB::table($tableName)
    ...
    {
        DB::table('deia_question_settings')->updateOrInsert(
            [
    ...
    {
        DB::table('deia_response_option_settings')->updateOrInsert(
            [
