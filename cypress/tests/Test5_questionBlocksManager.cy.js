describe('DEIA Survey - Question blocks manager', function () {
	...
	it('Creates DEIA question blocks', function () {
		...
		cy.get('form[id^="deiaQuestionBlockForm"] input[id^="title-en-"]').type(questionBlock.title);
		cy.get('form[id^="deiaQuestionBlockForm"] textarea[id^="description-en-"]').type(questionBlock.description);
	...
	it('Edits DEIA question blocks', function () {
		...
		cy.get('form[id^="deiaQuestionBlockForm"] input[id^="title-en-"]').clear().type(questionBlock.editedTitle);
		cy.get('form[id^="deiaQuestionBlockForm"] textarea[id^="description-en-"]').clear().type(questionBlock.editedDescription);
	...
	it('Creates DEIA question questions', function () {
		...
		cy.get('a:contains("Questions")').click();
